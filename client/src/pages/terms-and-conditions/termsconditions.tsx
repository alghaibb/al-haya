import "./termsconditions.styles.css";

const TermsConditionsPage = () => {
  return (
    <div className="termsConditionsContainer">
      <h1 className="termsConditionsTitle">Al Haya Terms and Conditions</h1>
      <div className="termsContent">
        ...
        <p>
          ...
          <span> [business entity name]</span> (“we,” “us” or “our”), concerning
          your access to and use of the <span>[website name.com]</span> website
        ...
        <p>
          <span>
            <strong>Option 2</strong>: [The Site is intended for users who are
          ...
          to these Terms and Conditions prior to you using the Site.
        </p>
        <p>
        ...
        <p>
          <span>[(4) you are not under the age of 13;]</span>
        </p>
        <p>
        ...
        <p>
          ...
          Policy <span>[CLICK HERE]/posted on the Site]</span>. By using the
        ...
        <p>
          ...
          <span>[us/our Designated Copyright Agent] </span>
        ...
        <p>
          ...
          <span>[YOUR ACCOUNT AND]</span> ANY CONTENT OR INFORMATION THAT YOU
        ...
        <p>
          ...
          <span>[name of state]</span> applicable to agreements made and to be
          entirely performed within the State/Commonwealth of{" "}
          <span>[name of state]</span>, without regard to its conflict of law
          principles.
        </p>
        <p>
        ...
        <p>
          <strong>Option 1</strong>: Any legal action of whatever nature brought
          by either you or us (collectively, the “Parties” and individually, a
          “Party”) shall be commenced or prosecuted in the state and federal
          courts located in<span> [name of county]</span> County,{" "}
          <span>[name of state]</span>, and the Parties hereby consent to, and
        ...
        <p>
          ...
          <span> ______</span> years after the cause of action arose.
        </p>
        <p>
        ...
        <p>
          ...
          <span>______</span> days before initiating arbitration. Such informal
        ...
        <p>
          ...
          at the AAA website <a href="https://www.adr.org">www.adr.org</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <span>
            <span>[name of county]</span>{" "}
          </span>
          County, <span>[name of state]</span>.
        </p>
        <p>
        ...
        <p>
          ...
          and federal courts located in <span>[name of county]</span> County,{" "}
          <span>[name of state]</span>, and the Parties hereby consent to, and
          waive all defenses of lack of personal jurisdiction, and forum non
          conveniens with respect to venue and jurisdiction in such state and
          federal courts.
        ...
        <p>
          ...
          way to the Site be commenced more than <span>_____</span> years after
        ...
        <p>
          ...
          <span>[name of county]</span> County, <span>[name of state]</span>.
          Except as otherwise provided herein, the Parties may litigate in court
          to compel arbitration, stay proceedings pending arbitration, or to
          confirm, modify, vacate, or enter judgment on the award entered by the
          arbitrator.
        ...
        <p>
          ...
          Transaction Act (UCITA) are excluded from these Terms and Conditions.
          In no event shall any Dispute brought by either Party related in any
          way to the Site or Services be commenced more than <span>______</span>{" "}
        ...
        <p>
          <strong>
            ...
            <span>[Informal Negotiations and]</span> Arbitration
          </strong>
        </p>
        <p>
          The Parties agree that the following Disputes are not subject to the
          above provisions concerning <span>[informal negotiations and]</span>{" "}
        ...
        <p>
          <span>
            ...
            AMOUNT PAID, IF ANY, BY YOU TO US DURING THE [_________] MONTH
            PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING [OR] [$_________].
        ...
        <p>
          ...
          <span>[your Contributions]</span>; (2) use of the Site; (3) breach of
          these Terms and Conditions; (4) any breach of your representations and
